...
for ki in range(K):
	...
	#No hyperparameter need to set for Glo-CNN
	#model = Global()
    #For Loc-CNN, set the input channel, patchsize, and location of patch 
    model = Local(1,
                        patch_size=30,LOC=[80,60,20]
                        )
